...
app.post('/api/chat', async (req, res) => {
  try {
    ...
    const selectedModel = model || process.env.OPENROUTER_MODEL || 'meta-llama/llama-3.2-3b-instruct:free';
...
app.post('/api/tts', async (req, res) => {
  try {
    ...
    const selectedVoice = voiceId || process.env.ELEVENLABS_VOICE_ID || '21m00Tcm4TlvDq8ikWAM'; // Rachel voice as default
